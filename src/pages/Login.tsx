...
const Login: FC<LoginProps> = ({}) => {
  ...
  const { user, Login, SignUpWithProvider } = useAuth();
  ...
  const handleLogin = (e: any) => {
    ...
    try {
      ...
      // After the user is logged in redirect the user to the  dashboard page.
    } catch (err) {
    ...
    <div style={{ width: "40%", margin: "auto" }}>
      ...
      <div>
        ...
        <Button
          ...
          className="bg-gray-800 text-white font-bold py-2 px-4 rounded inline-flex items-center flex-row"
        >
          <svg
